...
from selection_screen import mode_screen  # Importiere mode_screen aus selection_screen.py
...
def category_screen():
    ...
    categories = ["Politik", "Geographie", "General Knowledge", "Film/Kino", "Videospiele", "Anime/Manga"]
    ...
    for category in categories:
        btn = tk.Button(
            ...
            fg=btn_fg,
            relief="flat",
            command=lambda c=category: mode_screen()
        )
